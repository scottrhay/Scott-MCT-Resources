...
<h1 align="center">Azure AI - Building Intelligent Applications</h1>

<p align="center"><strong>From AI fundamentals to production-ready solutions</strong></p>
...
Transform documents, images, and other content into searchable knowledge using Azure AI Search and cognitive skills.

| Resource | Link |
|----------|------|
| **Official Course** | [AI-3022 Training](https://learn.microsoft.com/en-us/training/courses/ai-3022t00) |
| **Knowledge Mining Labs** | [GitHub Lab Instructions](https://microsoftlearning.github.io/mslearn-knowledge-mining/) |

### AI-3026: Develop AI Agents on Azure
*Build intelligent agents that can reason and take action*

Learn to create AI agents that can understand context, make decisions, and interact with multiple systems to accomplish complex tasks.

| Resource | Link |
|----------|------|
| **Official Course** | [AI-3026 Training](https://learn.microsoft.com/en-us/training/courses/ai-3026t00) |

### AZ-2005: Develop Generative AI Solutions with Azure OpenAI and Semantic Kernel
*Advanced development with OpenAI integration and orchestration*

Master the Semantic Kernel SDK to build sophisticated AI applications that can chain multiple AI services and integrate with your existing systems.

| Resource | Link |
|----------|------|
| **Applied Skills Assessment** | [Microsoft Learn - Applied Skills](https://learn.microsoft.com/en-us/credentials/applied-skills/develop-ai-agents-using-azure-openai-and-semantic-kernel/) |
| **Training Course** | [AZ-2005 Training](https://learn.microsoft.com/en-us/training/courses/az-2005t00) |
...
### AI-3002: Develop AI Information Extraction Solutions
...
*Strategic AI adoption for decision makers*

Perfect for executives and managers who need to understand AI's business impact without getting into technical details.

| Resource | Link |
|----------|------|
| **Training Course** | [AI-3017 Training](https://learn.microsoft.com/en-us/training/courses/ai-3017t00) |

### AI-3025: Work Smarter with AI
*Practical AI tools for everyday productivity*

Learn to use AI tools effectively in your daily work - perfect for any professional looking to boost productivity.

| Resource | Link |
|----------|------|
| **Training Course** | [AI-3025 Training](https://learn.microsoft.com/en-us/training/courses/ai-3025t00) |
...
*Creative AI applications for design and visualization*

Explore AI's creative potential through hands-on projects that combine technology with design thinking.

| Resource | Link |
|----------|------|
| **Training Course** | [AI-3024 Training](https://learn.microsoft.com/en-us/training/courses/ai-3024t00) |
...
- **[How to Deploy AI Safely](https://www.microsoft.com/en-us/security/blog/2025/05/29/how-to-deploy-ai-safely/)** - Security best practices for AI deployment
...
<p align="center">
  <a href="README.md"><img src="https://img.shields.io/badge/←_Back_to-Home-00BCD4?style=for-the-badge" alt="Home"/></a>
